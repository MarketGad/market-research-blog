...
const Privacy = function () {
    return (
        <div className="privacy container">
            <h3 className="center privacy-top">Privacy Policy</h3>
            <p className="flow-text">  This privacy policy has been compiled to better serve those who are concerned with how
            ...
            <h4 className="privacy-head">What personal information do we collect from the people that visit our blog,
            website or app?</h4>
            ...
            <h4 className="privacy-head"> When do we collect information?</h4>
            <p className="flow-text">We collect information from you when you register on our site or enter information on our
            site.</p>
            <h4 className="privacy-head">How do we use your information?</h4>
            <p className="flow-text">We may use the information we collect from you when you register, make a purchase, sign
            up for our newsletter, respond to a survey or marketing communication, surf the website, or
            use certain other site features just to ask for ratings and reviews of services or products.</p>
            <h4 className="privacy-head"> How do we protect your information?</h4>
            ...
            <h4 className="privacy-head"> Do we use ‘cookies’?</h4>
            <p className="flow-text">  We do not use cookies for tracking purposes. You can choose to have your computer warn
            you each time a cookie is being sent, or you can choose to turn off all cookies. You do this
            through your browser settings. Since browser is a little different, look at your browser’s Help
            ...
            may not function properly, that make your site experience more efficient and may not
            function properly.</p>
            <h4 className="privacy-head">Third-party disclosure</h4>
            <p className="flow-text">
                ...
                confidential. We may also release information when it’s release is appropriate to comply with
            ...
            <h4 className="privacy-head">Third-party links</h4>
            <p className="flow-text"> We do not include or offer third-party products or services on our website.</p>
            <h4 className="privacy-head">Google</h4>
            <p className="flow-text">Google’s advertising requirements can be summed up by Google’s Advertising Principles.
            They are put in place to provide a positive experience for users. Please visit the following
            link: https://support.google.com/adwordspolicy/answer/1316548?hl=en
            We may use Google AdSense Advertising on our website. Google, as a third-party vendor,
            uses cookies to serve ads on our site. Google’s use of the DART cookie enables it to serve
            ads to our users based on previous visits to our site and other sites on the Internet. Users may
            opt-out of the use of the DART cookie by visiting the Google Ad and Content Network
            privacy policy.</p>
            <h4 className="privacy-head">We may implement the following:</h4>
            <ol className="flow-text" type="1">
            ...
            <h4 className="privacy-head">Opting out:</h4>
            <p className="flow-text">
            ...
            <h4 className="privacy-head"> California Online Privacy Protection Act</h4>
            <p className="flow-text">
                ...
                <a href="http://consumercal.org/california-online-privacy-protection-act-
                caloppa/#sthash.0FdRbT51.dpuf">http://consumercal.org/california-online-privacy-protection-act-
                caloppa/#sthash.0FdRbT51.dpuf</a>
                <br />
            According to CalOPPA, we agree to the following:
            Users can visit our site anonymously. Once this privacy policy is created, we will add a link
            to it on our home page or as a minimum, on the first significant page after entering our
            website. Our Privacy Policy link includes the word ‘Privacy’ and can easily be found on the
            ...
            <h4 className="privacy-head">
                How does our site handle Do Not Track signals?</h4>
            <p className="flow-text">
                We honour Do Not Track signals and Do Not Track, plant cookies, or use advertising when a
                Do Not Track (DNT) browser mechanism is in place.
            </p>
            <h4 className="privacy-head">
                Does our site allow third-party behavioural tracking?</h4>
            <p className="flow-text">
                It’s also important to note that we do not allow third-party behavioural tracking</p>
            <h4 className="privacy-head">COPPA (Children Online Privacy Protection Act)</h4>
            <p className="flow-text">
            ...
            <br />
            We do not specifically market to children under the age of 13 years old. Do we let third-
            parties, including ad networks or plug-ins collect PII from children under 13?
            </p>
            <h4 className="privacy-head">Fair Information Practices</h4>
            <p className="flow-text">
            ...
            <p className="flow-text">
                We will notify the users via in-site notification within a month. We also agree to the
                ...
                principle requires not only that individuals have enforceable rights against data users, but also
